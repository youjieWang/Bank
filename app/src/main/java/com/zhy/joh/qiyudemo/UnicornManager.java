...
//        source.vipStaffWelcomeMsg = "客服的欢迎语";
    ...
    public static void setUiCustomization() {
        Log.i("class",uiCustomization().toString());
    ...
    private static UICustomization uiCustomization() {
        ...
        customization.inputTextColor = R.color.base_text;
                //访问者头像
        customization.rightAvatar = "com_Draker1\\app\\src\\main\\res\\drawable\\ysf_evaluation_star_enabled_dark.png";
        //客服头像
